...
```shell
[root@master istio-lab]# kubectl delete service service-js-nodeport service-python-nodeport

[root@master istio-lab]# kubectl delete -f kubernetes/dns-test.yaml

[root@master istio-lab]# kubectl delete -f service/js/service-js.yam
[root@master istio-lab]# kubectl delete -f service/python/service-python.yaml
[root@master istio-lab]# kubectl delete -f service/lua/service-lua.yaml
[root@master istio-lab]# kubectl delete -f service/node/service-node.yaml
[root@master istio-lab]# kubectl delete -f service/go/service-go.yaml
```
...
```shell
[root@master istio-lab]# kubectl apply -f service/go/service-go.yaml 
[root@master istio-lab]# kubectl apply -f service/node/service-node.yaml
[root@master istio-lab]# kubectl apply -f service/lua/service-lua.yaml
[root@master istio-lab]# kubectl apply -f service/python/service-python.yaml
[root@master istio-lab]# kubectl apply -f service/js/service-js.yaml
```
